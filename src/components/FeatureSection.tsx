    ...
    <section id="features" className="relative py-24 sm:py-32 overflow-hidden bg-white dark:bg-slate-950 transition-colors duration-300">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.div
            variants={fadeUp}
            className="md:col-span-3 group relative rounded-3xl bg-slate-50 dark:bg-slate-900/40 border border-slate-200/60 dark:border-slate-800/60 p-6 flex items-center justify-between overflow-hidden hover:shadow-xl hover:border-teal-200/60 dark:hover:border-teal-500/30 transition-all duration-300"
          >
