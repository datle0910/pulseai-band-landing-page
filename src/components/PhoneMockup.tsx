...
export default function PhoneMockup() {
  return (
    <div className="relative w-full max-w-[280px] sm:max-w-[320px] mx-auto scale-95 sm:scale-100">
      ...
      <div className="relative w-full aspect-[1/2.1] rounded-[3rem] bg-gradient-to-br from-slate-200 via-slate-400 to-slate-600 dark:from-slate-700 dark:via-slate-800 dark:to-slate-900 p-[3px] shadow-[0_20px_50px_rgba(0,0,0,0.2)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
          ...
          <div className="relative flex-1 rounded-[2.2rem] bg-slate-50 dark:bg-slate-950 overflow-hidden flex flex-col pt-12 pb-6">
            ...
            <div className="px-6 mb-6 flex justify-between items-center">
              <div>
                ...
                <h2 className="text-2xl font-black text-slate-900 dark:text-white">Tổng quan</h2>
              </div>
            ...
            <div className="px-6 mb-6 flex justify-center">
              <div className="relative w-40 h-40 flex items-center justify-center">
                ...
                <div className="absolute text-center">
                  <span className="block text-[10px] text-slate-500 font-bold uppercase tracking-widest">Kcal</span>
                  <span className="block text-2xl font-black text-slate-900 dark:text-white">846</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex-1 px-4 grid grid-cols-2 gap-3 pb-4 overflow-hidden">
              ...
              <div className="col-span-1 bg-white dark:bg-slate-900 rounded-2xl p-4 border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-bold text-slate-500 dark:text-slate-400">Giấc ngủ</span>
                </div>
                <div className="mt-2">
                  <div className="flex items-end gap-1">
              ...
              <div className="col-span-2 bg-gradient-to-br from-teal-500 to-cyan-500 rounded-2xl p-4 text-white shadow-lg shadow-teal-500/20">
                ...
                <p className="text-sm font-medium text-white/90 leading-tight">
                  Bạn đang hồi phục tốt. Nhịp tim nghỉ giảm 2bpm so với hôm qua. Sẵn sàng cho buổi tập nhẹ!
                </p>
              </div>
            ...
            {/* Bottom App Nav */}
            <div className="absolute bottom-0 inset-x-0 h-16 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-t border-slate-200 dark:border-slate-800 flex justify-between items-center px-8 z-20 pb-2">
